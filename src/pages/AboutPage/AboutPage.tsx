                ...
                <div className="card">
                  ...
                  <div className="card-body text-center py-5">
                    ...
                    <p>
                      ...
                      တို့အား အမှူးထား၍ ကမ္ဘာသူ ကမ္ဘာသား လူ နတ် ဗြာဟ္မာ ပုဂ္ဂိုလ် သတ္တဝါ တို့အား အမျှ အမျှ အမျှ ပေးဝေပါ၏။ <br/> အမျှ ရကြသည် ဖြစ်၍ ကိုယ် စိတ် နှစ်ဖြာ ကျန်းမာ ချမ်းသာကြပါစေ။
                    </p>
